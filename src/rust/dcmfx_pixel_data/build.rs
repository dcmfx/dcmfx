...
fn build_charls() {
  compile(
    &[
      "vendor/charls_2.4.4/charls_interface.cpp",
      "vendor/charls_2.4.4/src/charls_jpegls_decoder.cpp",
      "vendor/charls_2.4.4/src/charls_jpegls_encoder.cpp",
      "vendor/charls_2.4.4/src/jpeg_stream_reader.cpp",
      "vendor/charls_2.4.4/src/jpeg_stream_writer.cpp",
      "vendor/charls_2.4.4/src/jpegls_error.cpp",
      "vendor/charls_2.4.4/src/jpegls.cpp",
      "vendor/charls_2.4.4/src/validate_spiff_header.cpp",
      "vendor/charls_2.4.4/src/version.cpp",
    ],
    &["vendor/charls_2.4.4/include"],
    &[("CHARLS_STATIC", "1")],
    &[],
