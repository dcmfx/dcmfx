...
#define BITS_IN_JSAMPLE  12    /* use 8 or 12 (or 16 for lossless) */
...
/* IJG_INT32 must hold at least signed 32-bit values. */
typedef long IJG_INT32;
