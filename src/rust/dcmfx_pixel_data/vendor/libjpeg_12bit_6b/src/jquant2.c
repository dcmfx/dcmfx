 ...
 */
{
  ...
  int i, x, ncolors;
  IJG_INT32 minmaxdist, min_dist, max_dist, tdist;
  IJG_INT32 mindist[MAXNUMCOLORS];  /* min distance to colormap entry i */
...
find_best_colors (j_decompress_ptr cinfo, int minc0, int minc1, int minc2,
          int numcolors, const JSAMPLE colorlist[], JSAMPLE bestcolor[])
 ...
 */
{
  int ic0, ic1, ic2;
  int i, icolor;
  register IJG_INT32 * bptr;    /* pointer into bestdist[] array */
  JSAMPLE * cptr;       /* pointer into bestcolor[] array */
  IJG_INT32 dist0, dist1;       /* initial distance values */
  register IJG_INT32 dist2;     /* current distance in inner loop */
  IJG_INT32 xx0, xx1;       /* distance increments */
  register IJG_INT32 xx2;
  IJG_INT32 inc0, inc1, inc2;   /* initial values for increments */
  /* This array holds the distance to the nearest-so-far color for each cell */
  IJG_INT32 bestdist[BOX_C0_ELEMS * BOX_C1_ELEMS * BOX_C2_ELEMS];
